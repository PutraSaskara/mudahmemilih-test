...
const SearchInput = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log("Nama Caleg:", namaCaleg);
    // Update your search logic here based on the two inputs
    router.push(`/searchPage?provinsi=${encodeURIComponent(inputValue)}&namaCaleg=${encodeURIComponent(namaCaleg)}`);
    setInputValue("");
  ...
  return (
    <div className="">
      <div className="bg-white py-[12px] px-[14px] rounded-lg shadow-2xl ">
        <form onSubmit={handleNamaCalegChange}>
          <div className="relative ">
            ...
            <button
              type="submit"
              className=" md:w-72 md:h-10  my-auto flex flex-row text-center align-middle justify-center text-white md:bg-primary hover:bg-accent hover:text-primary hover:border-neutral-500 hover:border focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm md:px-  "
            >
              <FaSearch className=" md:flex text-center my-auto md:text-white font-sans md:mr-2  text-primary  hover:text-primary" />
              <h4 className="hidden md:flex md:text-[8px] text-[6px] my-auto ">CARI DAPIL</h4>
            </button>
            </div> */}
            <div className="flex flex-row">
            <input
            ...
            <button
              type="submit"
              onChange={handleNamaCalegChange}
              className="md:w-72 md:h-10  my-auto flex flex-row text-center align-middle justify-center text-white bg-primary  px-6 py-2 md:bg-primary hover:bg-accent hover:text-primary hover:border-neutral-500 hover:border focus:ring-4 focus:outline-none focus:ring-black font-medium rounded-lg text-sm md:px-2 "
            >
              <FaSearch className="hidden md:flex text-center my-auto md:text-white font-sans md:mr-2 text-primary hover:text-primary"  />
              <h4 className=" md:hidden md:text-[12px] text-[10px] my-auto ">CARI</h4>
              <h4 className="hidden  md:flex md:text-[12px] text-[10px] my-auto ">CARI KANDIDAT</h4>
            </button>
            </div>
            </div>
