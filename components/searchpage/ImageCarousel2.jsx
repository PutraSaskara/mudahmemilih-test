...
const ImageCarousel2 = ({
  ...
  return (
    ...
    >
      ...
      <h4 className="text-[7px] sm:text-[9px] md:text-[10px] font-sans font-bold text-center text-black lg:text-white bg-slate-100 lg:bg-transparent mb-2 lg:text-stroke-thin lg:text-stroke-color-black">
          {name}
      </h4>
      </div>
